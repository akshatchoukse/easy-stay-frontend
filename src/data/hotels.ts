...
export const hotels: Hotel[] = [
  {
    ...
    amenities: ["WiFi", "Spa", "Pool", "Restaurant", "Bar", "Gym", "Concierge", "Valet Parking"],
  ...
  },
  {
    ...
    amenities: ["WiFi", "Infinity Pool", "Spa", "Restaurant", "Bar", "Beach Access", "Yoga Studio", "Helipad"],
  ...
  },
  {
    ...
    amenities: ["WiFi", "Onsen", "Zen Garden", "Tea Room", "Restaurant", "Spa", "Meditation Room", "Library"],
  ...
  },
  {
    ...
    amenities: ["WiFi", "Pool", "Spa", "7 Restaurants", "Desert Safari", "Observatory", "Butler Service", "Helipad"],
  ...
  },
  {
    ...
    amenities: ["WiFi", "Hot Tub", "Fireplace", "Restaurant", "Bar", "Husky Sledding", "Whale Watching", "Sauna"],
