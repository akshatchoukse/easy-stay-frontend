...
import { Mail, MapPin, Phone, Diamond, Calendar, Users, AlertCircle, Send } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  className="glass-card p-8 flex items-start gap-5 group hover-lift border-primary/5 hover:border-primary/20 transition-all duration-500"
                >
                  <div className="text-primary/60 mt-0.5 group-hover:scale-110 group-hover:text-primary transition-all duration-500">{item.icon}</div>
                  <div>
